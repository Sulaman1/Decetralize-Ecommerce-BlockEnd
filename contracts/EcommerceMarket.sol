...
contract EcommerceMarket is ReentrancyGuard {
    ...
    function getIdToUnsoldMarketItem(uint256 item)
        public
        view
        returns (MarketItem memory)
    {
        return idToMarketItem[item];
    }
    ...
    function productPurchase(address nftContract, uint256 itemId)
        public
        payable
        nonReentrant
    {
